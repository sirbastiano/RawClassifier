...
class SVenusClassifier(pl.LightningModule):
    def __init__(self, image_dir='.', batch_size=32, lr=1e-3,image_size=(128, 128), train_split=0.5, val_split=0.3):
        ...
        mvit = K.contrib.MobileViT(mode='xxs')
        ...
        model = nn.Sequential(
            mvit,
            nn.AvgPool2d(image_size[0] // 32, 1),
            nn.Flatten(),
...
if __name__ == '__main__':
    ...
    save_metrics_to_csv(test_results, f'{home}/test_results/MobileVit_venus_classifier_{BS}_{LR}.csv')
